...
export const seedPackages = async (_req, res) => {
  ...
  const base = [
    ...
    { title: 'Rajasthan Royal Tour', slug: 'rajasthan-royal-7d', summary: 'Palaces, forts and desert dunes', description: 'Jaipur, Udaipur, Jodhpur and a night in Thar desert.', price: 61999, currency: 'INR', duration: 7, seats_available: 22, rating: 4.7, images: ['https://images.unsplash.com/photo-1524492412937-b28074a5d7da','https://images.unsplash.com/photo-1530638904213-7af4734d6e1b'], available_dates: [now], location_city: 'Jaipur', location_country: 'India', tags: ['heritage','india','desert'] },
    ...
    { title: 'Nepal Himalayan Trek', slug: 'nepal-trek-8d', summary: 'Everest viewpoints and Sherpa culture', description: 'Guided trek through the Annapurna region with teahouse stays.', price: 67999, currency: 'INR', duration: 8, seats_available: 18, rating: 4.7, images: ['https://images.unsplash.com/photo-1470246973918-29a93221c455'], available_dates: [now], location_city: 'Pokhara', location_country: 'Nepal', tags: ['trekking','asia','adventure'] },
    { title: 'Sydney Explorer', slug: 'sydney-explorer-5d', summary: 'Opera House, Harbour Bridge and Bondi Beach', description: 'Experience Sydney’s highlights with a Blue Mountains excursion.', price: 164999, currency: 'INR', duration: 5, seats_available: 14, rating: 4.6, images: ['https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d6'], available_dates: [now], location_city: 'Sydney', location_country: 'Australia', tags: ['city','australia','coastal'] },
    { title: 'Santorini Sunset Escape', slug: 'santorini-sunset-5d', summary: 'Whitewashed villages and caldera views', description: 'Stay in Oia with wine tasting and sailboat sunset tour.', price: 179999, currency: 'INR', duration: 5, seats_available: 12, rating: 4.9, images: ['https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=1400&q=80'], available_dates: [now], location_city: 'Santorini', location_country: 'Greece', tags: ['island','europe','romantic'] },
    { title: 'Canadian Rockies Roadtrip', slug: 'canadian-rockies-7d', summary: 'Banff, Jasper and Lake Louise', description: 'Self-drive package with scenic stays and glacier excursion.', price: 189999, currency: 'INR', duration: 7, seats_available: 16, rating: 4.8, images: ['https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1400&q=80'], available_dates: [now], location_city: 'Banff', location_country: 'Canada', tags: ['roadtrip','america','nature'] },
    { title: 'Vietnam Discovery', slug: 'vietnam-discovery-7d', summary: 'Hanoi, Ha Long Bay and Ho Chi Minh City', description: 'Cruise the limestone karsts and explore vibrant street food scenes.', price: 69999, currency: 'INR', duration: 7, seats_available: 22, rating: 4.6, images: ['https://images.unsplash.com/photo-1500534314209-a25ddb2bd429'], available_dates: [now], location_city: 'Hanoi', location_country: 'Vietnam', tags: ['asia','culture','cruise'] },
    { title: 'South Africa Safari', slug: 'south-africa-safari-6d', summary: 'Big Five sightings and Cape Town charm', description: 'Kruger safari, Cape Peninsula tour and vineyard tastings.', price: 214999, currency: 'INR', duration: 6, seats_available: 12, rating: 4.9, images: ['https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1400&q=80&sat=-50'], available_dates: [now], location_city: 'Cape Town', location_country: 'South Africa', tags: ['safari','africa','wildlife'] },
    { title: 'Brazil Carnival Experience', slug: 'brazil-carnival-6d', summary: 'Rio de Janeiro samba and beaches', description: 'Attend Carnival parade, visit Christ the Redeemer and Sugarloaf.', price: 159999, currency: 'INR', duration: 6, seats_available: 18, rating: 4.7, images: ['https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d'], available_dates: [now], location_city: 'Rio de Janeiro', location_country: 'Brazil', tags: ['festival','america','party'] },
    { title: 'Iceland Northern Lights', slug: 'iceland-aurora-5d', summary: 'Glaciers, waterfalls and aurora hunting', description: 'Golden Circle tour, Blue Lagoon soak and nightly aurora chase.', price: 189999, currency: 'INR', duration: 5, seats_available: 14, rating: 4.9, images: ['https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1400&q=80&sat=50'], available_dates: [now], location_city: 'Reykjavik', location_country: 'Iceland', tags: ['northern-lights','europe','adventure'] }
  ];

  const operations = base.map((pkg) => ({
    updateOne: {
      filter: { slug: pkg.slug },
      update: { $set: { ...pkg, created_at: pkg.created_at ?? now, updated_at: now } },
      upsert: true
    }
  }));

  const result = await TravelPackage.bulkWrite(operations, { ordered: false });
  const total = await TravelPackage.countDocuments();

  return res.status(200).json({
    message: 'Packages upserted',
